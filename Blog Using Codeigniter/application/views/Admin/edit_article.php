    ...
    <div class="container animated fadeIn" style="margin-top: 20px;">
        ...
        <div class="row">
          <div class="col-md-6 offset-md-3">
              ...
              <?php echo form_open("Admin/updateArticle/{$article->article_id}"); ?>
             
<!--          <div class="" id="pnl">-->
                         <div class="card-header text-center text-white bg-dark " style="font-family: cursive;font-weight: bold;font-size: 20px;border-top-left-radius: 10px;border-top-right-radius: 10px; ">Edit Article</div>
...
<!--        <input type="email" class="form-control" id="email"/>-->
        <?php echo form_input(['class'=> 'form-control','placeholder'=>'Enter your title','name'=>'article_title','value'=> set_value('article_title',$article ->article_title)]);?>
...
<!--        <input type="email" class="form-control" id="email"/>-->
        <?php echo form_textarea(['class'=> 'form-control','placeholder'=>'Enter your article...','name'=>'article_body','value'=> set_value('article_body',$article ->article_body)]);?>
