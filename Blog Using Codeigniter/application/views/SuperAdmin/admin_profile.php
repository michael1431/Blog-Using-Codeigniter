                            ...
                            <div class="col-md-4 col-md-offset-4">
                                ...
                                <div class="overlay-box">
                                    <div class="user-content text-center">
                                     ...
                                     <a class="profile-pic" href="#"> <img class="img-thumbnail mx-auto d-block" src="<?php echo $this->session->userdata('a_pic'); ?>"  width="140px" height="140px"/></a>
                                ...
                                <table class="table table-striped table-condensed">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><b><?php echo $admin_infos->a_name; ?></b></td>
                                         
                                        </tr>
                                        <tr>
                                            <td class="text-right"><b>Email :</b></td>
                                            <td><b><?php echo $admin_infos->a_email; ?></b></td>
                                         
                                        </tr>
                                        <tr>
                                            <td class="text-right"><b>Contact :</b></td>
                                            <td><b><?php echo $admin_infos->a_contact; ?></b></td>
           
                                        </tr> 
                                          <tr>
                                            <td class="text-right"><b>Status :</b></td>
                                            <td><b><?php 
                                                 if($admin_infos->a_status == 1) {
